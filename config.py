...
# 색상
SKY_COLOR, GRASS_COLOR, DIRT_COLOR, STONE_COLOR = (135, 206, 235), (34, 139, 34), (139, 69, 19), (130, 130, 130)
...
# --- ▼▼▼ 낙하 데미지 상수 추가 ▼▼▼ ---
SAFE_FALL_DISTANCE = TILE_SIZE * 4  # 4칸 (160픽셀)까지는 안전
FALL_DAMAGE_SCALAR = 0.25            # 안전 높이를 초과한 픽셀당 0.5의 데미지
